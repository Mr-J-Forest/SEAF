"""Complete APEX restored from historical commit ``42d8449``.

This module is intentionally isolated from :mod:`seaf_model`.  The restored
experiment therefore preserves the current SEAF implementation and can be
removed without changing the active model or any existing result directory.
"""
...
class APEXNet(nn.Module):
    """Complete historical APEX: AP skip, spectral encoder, and ensemble gate."""
