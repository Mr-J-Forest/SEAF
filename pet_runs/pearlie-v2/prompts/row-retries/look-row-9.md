Create Codex v2 pet look row 9 for `pearlie` as exactly 8 full-body frames in this order: 000, 022.5, 045, 067.5, 090, 112.5, 135, 157.5.
...
REPAIR DIRECTION LOCK: row 9 uses only the arc `000 up -> 090 screen-right -> 180 down`. The sixth, seventh, and eighth poses (`112.5`, `135`, `157.5`) must remain screen-right-facing while their gaze lowers toward the bottom; their nose tip, eye centers, and visible face plane must never cross to screen-left. Do not use the `270 screen-left` cardinal family anywhere in this row; it belongs only to row 10. In particular, the final two poses must be right-facing/downward intermediates, not left-facing profiles.
